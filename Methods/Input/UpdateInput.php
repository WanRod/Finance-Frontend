...
if (!empty($_POST['id']) && !empty($_POST['input-type-id']) && !empty($_POST['description']) && !empty($_POST['value']) && !empty($_POST['date']))
{
    $response = InputRepository::update($_POST['id'], $_POST['input-type-id'], $_POST['description'], $_POST['value'], $_POST['date']);
